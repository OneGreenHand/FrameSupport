 ...
 */
public abstract class BaseSwipeListLazyLoadFragment<P extends BasePresenter, B extends BaseBean, AB> extends BaseSwipeLazyLoadFragment<P, B> implements BaseSwipeListView<B> {
