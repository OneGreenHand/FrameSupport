...
public class StatusBarUtil {
    ...
    public static void checkAndroidSetStatusColor(Activity activity, int colorType, View view) {
        if (StatusBarLightMode(activity, true) != 0) {//MIUI、Flyme和6.0以上版本其他Android
            switch (colorType){
                case 1:
                    setColor(activity, activity.getResources().getColor(R.color.red), 0);
                    StatusBarLightMode(activity, true);
                    break;
                case 2:
                    setColor(activity, activity.getResources().getColor(R.color.blue), 0);
                    StatusBarLightMode(activity, false);
                    break;
                case 3:
                    setColor(activity, activity.getResources().getColor(R.color.green), 0);
                    StatusBarLightMode(activity, false);
                    break;
                case 4:
                    setColor(activity, activity.getResources().getColor(R.color.colorPrimary), 0);
                    StatusBarLightMode(activity, true);
                    break;
                case 5:
                    setColor(activity, activity.getResources().getColor(R.color.yellows), 0);
                    StatusBarLightMode(activity,false);
                    break;
                case 6:
                    ...
                    break;
                default:
                    setTranslucent(activity,50);
                    break;
            }
        } else {//正常手机机型
            switch (colorType){
                case 1:
                    setColor(activity, activity.getResources().getColor(R.color.red), 60);
                    break;
                case 2:
                    setColor(activity, activity.getResources().getColor(R.color.blue), 0);
                    break;
                case 3:
                    ...
                    break;
                case 4:
                    setColor(activity, activity.getResources().getColor(R.color.colorPrimary), 60);
                    break;
                case 5:
                    setColor(activity, activity.getResources().getColor(R.color.yellows), 0);
                    break;
